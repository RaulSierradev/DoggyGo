...
function HomeDashboard() {
	return (
		<div>
			...
			<div className="bg-slate-700 px-10 py-10 h-screen gap-4 ">
				<div className="bg-zinc-800 rounded-lg h-full">
					...
					<div className="flex mt-8 flex-1 gap-4">
						<div className="basis-1/2 ml-5 bg-white rounded-xl py-2 px-2">
						...
						<div className="basis-1/2 flex-col rounded-lg bg-white py-2 px-2 mr-5">
							<h2 className=" text-black text-3xl font-medium mb-3">
								Paseos Recientes
							</h2>
							<Orders
