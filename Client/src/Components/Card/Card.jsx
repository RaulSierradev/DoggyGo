...
const Card = ({ walker }) => {
  ...
  return (
    <div className='max-w-sm w-full lg:max-w-full lg:flex'>
      <div className='border border-gray-400 lg:border lg:border-gray-400 bg-white rounded lg:rounded-b-none lg:rounded-r p-4 flex flex-row justify-between leading-normal'>
